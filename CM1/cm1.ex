defmodule CM1 do
  defmodule Coder do
    ...
    def encode(str), do: encode(String.to_charlist(str), <<>>)

    defp decode(<<>>, acc), do: acc |> Enum.reverse |> List.to_string
    defp decode(<<0b00::2,      rest::bits>>, acc), do: decode(rest, [?0|acc])
    defp decode(<<0b01::2,      rest::bits>>, acc), do: decode(rest, [?1|acc])
    defp decode(<<0b100::3,     rest::bits>>, acc), do: decode(rest, [?2|acc])
    defp decode(<<0b1010::4,    rest::bits>>, acc), do: decode(rest, [?3|acc])
    defp decode(<<0b1011::4,    rest::bits>>, acc), do: decode(rest, [?4|acc])
    defp decode(<<0b1100::4,    rest::bits>>, acc), do: decode(rest, [?5|acc])
    defp decode(<<0b11010::5,   rest::bits>>, acc), do: decode(rest, [?6|acc])
    defp decode(<<0b11011::5,   rest::bits>>, acc), do: decode(rest, [?7|acc])
    defp decode(<<0b111000::6,  rest::bits>>, acc), do: decode(rest, [?8|acc])
    defp decode(<<0b111001::6,  rest::bits>>, acc), do: decode(rest, [?9|acc])
    defp decode(<<0b1110100::7, rest::bits>>, acc), do: decode(rest, [?+|acc])
    defp decode(<<0b1110101::7, rest::bits>>, acc), do: decode(rest, [?-|acc])
    defp decode(<<0b1110110::7, rest::bits>>, acc), do: decode(rest, [?*|acc])
    defp decode(<<0b1110111::7, rest::bits>>, acc), do: decode(rest, [?/|acc])

    defp encode([], acc), do: acc
    defp encode([?0|rest], acc), do: encode(rest, <<acc::bits, 0b00::2>>)
    defp encode([?1|rest], acc), do: encode(rest, <<acc::bits, 0b01::2>>)
    defp encode([?2|rest], acc), do: encode(rest, <<acc::bits, 0b100::3>>)
    defp encode([?3|rest], acc), do: encode(rest, <<acc::bits, 0b1010::4>>)
    defp encode([?4|rest], acc), do: encode(rest, <<acc::bits, 0b1011::4>>)
    defp encode([?5|rest], acc), do: encode(rest, <<acc::bits, 0b1100::4>>)
    defp encode([?6|rest], acc), do: encode(rest, <<acc::bits, 0b11010::5>>)
    defp encode([?7|rest], acc), do: encode(rest, <<acc::bits, 0b11011::5>>)
    defp encode([?8|rest], acc), do: encode(rest, <<acc::bits, 0b111000::6>>)
    defp encode([?9|rest], acc), do: encode(rest, <<acc::bits, 0b111001::6>>)
    defp encode([?+|rest], acc), do: encode(rest, <<acc::bits, 0b1110100::7>>)
    defp encode([?-|rest], acc), do: encode(rest, <<acc::bits, 0b1110101::7>>)
    defp encode([?*|rest], acc), do: encode(rest, <<acc::bits, 0b1110110::7>>)
    defp encode([?/|rest], acc), do: encode(rest, <<acc::bits, 0b1110111::7>>)
  end
